...
const rides = [
  {
    ...
    origin_latitude: 27.71724,
    origin_longitude: 85.32396,
    destination_latitude: 28.20958,
    destination_longitude: 83.98556,
    ride_time: 391,
    fare_price: 19500,
    payment_status: "paid",
    driver_id: 2,
        ...
        ListHeaderComponent={() => (
          <>
            <View className="flex-row items-center justify-between my-5">
              <Text
                className="text-2xl font-JakartaExtraBold w-full max-w-[300px]"
                numberOfLines={1}
                ellipsizeMode="tail"
              >
                Welcome,{" "}
